...
public class RabbitPropertiesConfiguration {
    ...
    public static final String ROUTINGKEY_B = "*.test2.*";
    ...
    public Binding binding() {
        return BindingBuilder.bind(queueA()).to(defaultExchange()).with(RabbitPropertiesConfiguration.ROUTINGKEY_A);
    }

    @Bean
    public Binding bindingB(){
        return BindingBuilder.bind(queueB()).to(topicExchange()).with(RabbitPropertiesConfiguration.ROUTINGKEY_B);
    }
